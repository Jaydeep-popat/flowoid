...
const allTestimonials = [
  { tf: true,  title: 'Amazing to work with',                   q: "Our redesign result is thrilling. Flowoid was amazing to work with, making the process fun and stress-free. They are always super responsive.",                                            init:'RK', name:'Rajesh Kumar',  role:'CEO & Founder @ClickMagick',      rating:5 },
  ...
  { tf: false, title: 'Reliable, Fast, Easy',                   q: "Flowoid was incredibly fast, offering numerous options. They solicit feedback constantly and worked hard to create the perfect design for us.",                                               init:'VS', name:'Vikram Singh',   role:'Co-Founder @Legacy Blueprint',   rating:5 },
  { tf: true,  title: 'Flowoid is one of the most talented', q: "Flowoid is one of the most talented teams I've worked with. They go above and beyond in understanding and executing design excellence.",                                                    init:'AP', name:'Aarav Patel',    role:'Marketing Lead @Stepsize',        rating:5 },
  { tf: false, title: 'Game-Changing Partnership',              q: "Working with Flowoid was a game-changer. Their mobile app development expertise helped us launch our product successfully and reach new market heights.",                                      init:'AM', name:'Arjun Mehta',    role:'CTO @InnovateCorp',               rating:5 },
  ...
  { tf: false, title: 'Incredibly professional team',           q: "The Flowoid team is incredibly professional and talented. They delivered our e-commerce platform on time, within budget, and with outstanding quality.",                                       init:'PS', name:'Priya Sharma',   role:'Marketing Director @GrowthFirst', rating:5 },
  { tf: true,  title: 'Excellent Design',                       q: "Working with Flowoid has been a pleasure. They were fast, communicative, and crafted an excellent design that met all our requirements perfectly.",                                            init:'AG', name:'Ananya Gupta',   role:"CEO & Co-Founder @Prönö",        rating:5 },
  { tf: false, title: 'Transformed our digital presence',       q: "Flowoid completely transformed our digital presence. Their team delivered exceptional results that far exceeded our expectations and business goals.",                                         init:'NS', name:'Neha Sharma',    role:'CEO @TechFlow Solutions',         rating:5 },
  ...
  { tf: true,  title: 'ERP integration experts',                q: "Our 8 disconnected systems now talk seamlessly. Flowoid's ERP integration saved our team 15 hours a week. The ROI was visible in month one.",                                                 init:'SM', name:'Suresh Menon',   role:'COO @RetailGiant',               rating:5 },
      ...
      >
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-[1.05rem] leading-[1.82] text-body max-w-[580px]">
            Don't take our word for it — hear from the 300+ companies and leaders who've trusted Flowoid to power their digital transformation.
          </motion.p>
        </motion.div>
      </div>
