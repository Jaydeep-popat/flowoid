...
/* ─── Form state ─── */
interface FormState { name: string; email: string; phone: string; location: string; message: string; }
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute right-[-80px] top-[-100px] w-[520px] h-[520px] rounded-full pointer-events-none animate-pulse3" style={{ background: 'radial-gradient(circle,rgba(45,43,107,.08),transparent 70%)', filter: 'blur(55px)' }} />
          ...
          <motion.div variants={fadeRight} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-border shadow-sm hover:shadow-md hover:border-b4 transition-[border,box-shadow] duration-200"
              >
      ...
      <section className="bg-page py-20 px-[5%]">
        <div ref={contactRef} className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-14">
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-[.92rem] text-body leading-[1.75] max-w-[580px] mx-auto md:mx-0">
                You don't need a fully formed plan to reach out. Share what's on your mind — a rough concept, a challenge you're facing, or even just a question.
              </p>
            </div>

            <div className="flex-shrink-0">
              <motion.a
                href="mailto:popatjaydeep21@gmail.com"
        ...
        >
          ...
          <div className="relative z-[2]">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link to="/projects" className="inline-flex items-center gap-2 px-7 py-[13px] rounded-full text-[.9rem] font-semibold text-white border border-white/25 bg-white/8 transition-all duration-[280ms] hover:bg-white/18 hover:border-white/50">
